...
\cvcomputer{Data Analytics}{Eviews, R, Python}{BDD}{SQLite, PostgreSQL et MySQL}{}
\cvcomputer{OS}{MacOS,  GNU/Linux, \newline{} Windows X}{Outils}{\LaTeX. \newline{}Microsoft Office et LibreOffice.}{}
\subsection{Langues}
\cvline{Fran\c{c}ais}{Tr\`{e}s Bien}
\cvline{Cr\'{e}ole}{Tr\`{e}s Bien}
\cvline{Anglais}{Bien}
\section{Centres d'intérêt}
\cvline{Web D\'{e}veloppement}{Suivi de Tutorial en ligne sur le d\'{e}veloppement de site web sur udemy et studioweb (Html5, Css3, JavaScript, PHP, Django, Mysql et sqlite).}
\cvline{Data Science}{Suivi de tutorial en ligne sur Udemy}
\end{document}