...
## Project Overview
This repository is a structured collection of professional documents, primarily **Curriculum Vitae (CV)**, **Resumes**, and **Terms of Reference (TDR)** for **Alexandro Disla**. It uses **LaTeX** (specifically the `moderncv` class) for high-quality document generation and **Pandoc** for document conversion.
...
## Key Files
- `alexandro.disla_cv.tex`: Main French CV source (using `moderncv` classic).
- `alexandrodislaResume.tex`: Main English Resume source.
